...
backend_args = None
data_root = '/home/xmz/code/detection/datasets/NEU-DET-200/'
...
test_evaluator = dict(
    ann_file=
    '/home/xmz/code/detection/datasets/NEU-DET-200/annotations/instances_val2017.json',
    backend_args=None,
    metric='bbox',
    type='CocoMetric')
test_pipeline = [
...
work_dir = './work_dirs/lgnet_rbb_rab_mssab_pcsab_mffn_36e_NEU-DET-200'
